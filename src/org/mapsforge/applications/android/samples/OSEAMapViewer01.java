 ...
 */
public class OSEAMapViewer01 extends BasicMapViewerXml {
    ...
    protected void onPause() {
        ...
        String currentFileNamePath = mMapfilename;
        Log.d(SamplesApplication.TAG, "last current map " + currentFileNamePath);
        this.preferencesFacade.putString(currentMapNamePathKey, currentFileNamePath);
        this.preferencesFacade.save();
        super.onPause();
    }
    ...
    protected void createLayers() {
        ...
        // sometimes mMapFileName starts wit /mnt , we test this in getMapFile();
