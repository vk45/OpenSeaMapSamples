...
public class OpenSeaMapViewerCompassDemo extends OSEAMapViewerWithSeamarks {
	private static final String TAG = "OpenSeaMapViewCompassDemo";
    private SensorManager mSensorManager;
    private RotateView mRotateView;
    Button mPlusButton = null;
    Button mMinusButton = null;
    ...
    private class RotateView extends ViewGroup implements SensorListener {
        ...
        private SeamarkLayer mInnerSeamarkLayer = null;
        ...
        public void onSensorChanged(int sensor, float[] values) {
            ...
            synchronized (this) {
                ...
                if (Math.abs(mHeading - newHeading) > 5.0f ){
                    Log.d(TAG, "mHeading: " + mHeading + "  new heading: " + newHeading + "  x: " + values[0] + "y: " + values[1] + "z: " + values[2]);
                    //mHeading = newHeading +180.0f;
                	if (!mNorthFixed) {
                         mHeading = newHeading;
                         mHeadingInfo.setText( Integer.valueOf((int)mHeading)+ " \n\n");
                         if (mInnerSeamarkLayer != null) {
                        	 mInnerSeamarkLayer.setHeading(mHeading);
                        	 mInnerSeamarkLayer.requestRedraw();
                         }
        ...
        public void setInnerSeamarkLayer( SeamarkLayer pSeamarkLayer) {
        	mInnerSeamarkLayer = pSeamarkLayer;
        }
    ...
    private void makeGUI() {
        ...
        mHeadingInfo.setText("heading: " + Integer.valueOf((int) mRotateView.getHeading()) + "   " + "\n \n  ");
    ...
    protected void onResume() {
        ...
        mRotateView.setInnerSeamarkLayer(mSeamarkLayer);
