...
public class BasicMapViewer extends Activity implements OnSharedPreferenceChangeListener {
	...
	protected MapPosition getInitialPosition() {
		...
		if (result.isSuccess()) {
			...
			if (mapFileInfo != null && mapFileInfo.startPosition != null) {
				...
				//return new MapPosition(new LatLong(52.517037, 13.38886), (byte) 3);
				return new MapPosition(new LatLong(53.997,11.3), (byte) 6);
			}
		}
	...
	protected File getMapFile() {
		String baseDirPath = DirectoryUtils.getBaseDirectoryPath();
		String mapDirPath = DirectoryUtils.getMapDirectoryPath();
		File file = new File(mapDirPath, this.getMapFileName());
        //File file = new File(this.getMapFileName());
	...
	protected String getMapFileName() {
        ...
        //String homeDirName = homeDir.getAbsolutePath();
		//return homeDirName + "/germany.map";
		//return "germany.map";
		String aFileName = Samples.DEFAULT_MAPFILE_NAME;
		return aFileName;
	}
