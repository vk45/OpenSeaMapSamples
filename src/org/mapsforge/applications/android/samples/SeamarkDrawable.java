...
public class SeamarkDrawable {
    ...
    private Bitmap.Config mBitmapConfig = Bitmap.Config.ARGB_8888;
    private float mDisplayFactor = 1.0f; // for Nexus 7 with 320 DPI this will set to 2
    ...
    private void handleBridgeWithSymbol() {
        ...
        if (bridgeCategory != null) {
            ...
            float centerX = mBitmapWidth *0.5f;
            float centerY = mBitmapHeight *0.5f;
            float deltaX = 8.0f * mDisplayFactor;  // for 320 dpi
            float deltaY = 6.0f * mDisplayFactor;
    ...
    private void handleBridgeWithInfo() {
        ...
        if (bridgeCategory != null) {
            ...
            float savedTextSize= mPaint.getTextSize();
            mPaint.setTextSize(savedTextSize*mDisplayFactor);
            ...
            float centerX = mBitmapWidth *0.5f;
            float centerY = mBitmapHeight *0.5f;
            float deltaX = (textwidth / 2.0f + 2.0f)*mDisplayFactor;
            float deltaY = 12.0f*mDisplayFactor;
    ...
    private void handleLandMark ( ){
        ...
        if (lightColour != null){
            ...
            if (aLightSymbol != null) {
                ...
                if (aLightPath!= null) {
                    aLightPath.setFillType(Path.FillType.EVEN_ODD);
    ...
    private void displayInnerBody(String type , Canvas canvas, Matrix matrix, String shapeName) {
        ...
        if (aPattern == null) {
            ...
            if (innerSeamarkSymbol != null ) {
                ...
                if (innerPath != null ){
                    if (matrix == null) {
                        innerPath.setFillType(Path.FillType.EVEN_ODD);
